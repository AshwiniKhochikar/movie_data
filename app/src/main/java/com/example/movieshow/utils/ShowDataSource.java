 ...
 */
public class ShowDataSource extends androidx.paging.PageKeyedDataSource<Integer, SearchShow>
{
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params,
        @NonNull final LoadInitialCallback<Integer, SearchShow> callback)
    {
    ...
    public void loadBefore(@NonNull final LoadParams<Integer> params,
        @NonNull final LoadCallback<Integer, SearchShow> callback)
    {
