...
public class ShowListAdapter extends PagedListAdapter<SearchShow, ShowListAdapter.ShowListViewHolder>
{
    ...
    private static DiffUtil.ItemCallback<SearchShow> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<SearchShow>()
            {
                @Override
                public boolean areItemsTheSame(SearchShow oldItem, SearchShow newItem)
                {
                    return oldItem.getImdbID() == newItem.getImdbID();
                }

                @Override
                public boolean areContentsTheSame(SearchShow oldItem, SearchShow newItem)
                {
    ...
    class ShowListViewHolder extends RecyclerView.ViewHolder
    {
        ...
        void bind(final SearchShow showDetails)
        {
